export const WASTE_TYPES = ["Plastic", "Organic", "Metal", "E-Waste"];

export const CONVERSION_METHODS = ["Pyrolysis", "Plasma Gasification", "Anaerobic Digestion"];
...
export const FUEL_OUTPUT_FRACTIONS = {
  "Plastic": {
